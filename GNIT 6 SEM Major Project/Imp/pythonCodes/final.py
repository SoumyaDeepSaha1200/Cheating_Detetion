...
merged_df = pd.merge(merged_df, output_data[['Name', 'Head Movement', 'Left Eye','Right Eye','Head Position','Date','Time','SessionID','StudentID','SuspiciousObject','SoundDetection','MultiplePersons','BackgroundNoiseLevel']], on='Name', how='left')

# Categorize performance based on 'Cheating Incident Count (Yes)'
