...
output_file_path = r'D:\My Success Key\Projects\On Going College Project\Original\Experiment - Copy\Django_face_recognition_and_cheating_detection\output.csv'
user_data_file_path = r'D:\My Success Key\Projects\On Going College Project\Original\Experiment - Copy\Django_face_recognition_and_cheating_detection\user_data.csv'
filtered_output_file_path = r'D:\My Success Key\Projects\On Going College Project\Original\Experiment - Copy\Django_face_recognition_and_cheating_detection\final.csv'

# Check if the output file exists
if not os.path.exists(output_file_path):
    raise FileNotFoundError(f"The file {output_file_path} does not exist. Please check the path and try again.")
...
# Include performance columns in the filtered data
filtered_data = merged_df[['Name', 'Attendance Count', 'Cheating Incident Count (Yes)', 'Cheating Incident Count (No)', 
                           'Head Movement', 'Left Eye', 'Right Eye', 'Head Position', 'Date', 'Time', 
                           'SessionID', 'StudentID', 'SoundDetection', 'BackgroundNoiseLevel', 'Performance', 
                           'Marks', 'Difficulty', 'Subject', 'Overall Performance']]
